...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    'Email us: [1]%email%[/1]' => 'Écrivez-moi : [1]%email%[/1]',
    'Call us: [1]%phone%[/1]' => 'Appelez-moi : [1]%phone%[/1]',
  ...
  array (
    'Customer service - Contact us' => 'Service client - Me contacter',
  ...
  'ShopThemeCatalog' => 
  array (
    'Popular Products' => 'Offres les plus intéressantes',
    'Discount' => 'Remise',
    'Items' => 'Produits',
    'Item' => 'Article',
...
',
  ...
  array (
    ...
    'There was an error during the uninstallation. Please contact us through Addons website.' => 'Une erreur s\'est produits lors de la désinstallation. Contactez-nous sur le site web d\'Addons.',
  ...
  array (
    ...
    'Get referred and earn a discount voucher of <span><strong>{discount}!</strong></span>' => 'Devenez son(sa) filleul(e) et remportez un bon d\'achat de <span><strong>{discount}</strong></span> !',
    'It&#039;s very easy to sign up. Just click here!' => 'Pour nous rejoindre, rien de plus simple : cliquez ici !',
...
Thanks for your patience.' => 'Notre boutique est en cours de mise à jour, nous revenons rapidement ! Merci pour votre patience.',
  ...
  array (
    ...
    'The value of the PHP.ini setting "max_input_vars" must be increased to %value% in order to be able to submit the product form.' => 'La valeur du paramètre "max_input_vars" dans le fichier PHP.ini doit être élevée à %value% afin de permettre la soumission du formulaire produit.',
